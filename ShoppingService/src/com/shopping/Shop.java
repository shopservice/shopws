...
public class Shop {
	...
	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	public Product create(Product wine) {
	...
	@Consumes({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	public Product update(Product wine) {
	...
	@Consumes({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	public Confirm buy(Order order) throws Exception {
		System.out.println("mediate order process");
		
        ShopMediator smediator = new ShopMediator();
        
        Confirm confirm = new Confirm();
        confirm = smediator.doBuy(order);
		return confirm;
	}
